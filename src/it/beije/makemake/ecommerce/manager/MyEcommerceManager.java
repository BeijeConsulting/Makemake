package it.beije.makemake.ecommerce.manager;
...
import it.beije.makemake.db.jpa.SingletonJpa;
import it.beije.makemake.ecommerce.Order;
import it.beije.makemake.ecommerce.Order_item;
...
public class MyEcommerceManager { // metodi per gestire db ecommerce
	...
	public static void selectUtenti() {// visualizza utenti
	...
	public static void selectProdotti() {// visualizza prodotti
		EntityManager entityManager = SingletonJpa.getInstance();
